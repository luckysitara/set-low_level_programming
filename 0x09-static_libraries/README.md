...
SE 200: C Programming I Average: 96.8%
Welcome to Week 6!
C - Static Libraries
Build Your Own C Static Library
Pop Quiz: Build Your Own C Static Library
Reference Card: Static Libraries
Wrapping Up Week 6
Coding Project: C - Static Libraries
Coding Project: C - Static Libraries

    Weight: 75
    Project will start Mar 15, 2026 5:00 PM, must end by Mar 29, 2026 4:59 PM

Great stuff! That module didn’t stand a chance.
...
Let’s complete the following short MCQ check, so that you can access your project!
