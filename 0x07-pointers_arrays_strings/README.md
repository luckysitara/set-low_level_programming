...
julien@ubuntu:~/0x07$ cat 6-main.c 
#include "main.h"
#include <stdio.h>
...
julien@ubuntu:~/0x07$ gcc -Wall -pedantic -Werror -Wextra -std=gnu89 _putchar.c 6-main.c 6-print_chessboard.c -o 6-print_chessboard
julien@ubuntu:~/0x07$ ./6-print_chessboard 
rkbqkbkr
pppppppp
...
julien@ubuntu:~/0x07$ gcc -Wall -pedantic -Werror -Wextra -std=gnu89 7-main.c 7-print_diagsums.c -o 7-print_diagsums
julien@ubuntu:~/0x07$ ./7-print_diagsums 
113, 1016
1214556093, 1137318
julien@ubuntu:~/0x07$ 
