...
AI: How to Use AI for Concept Comparison
Wrapping Up Week 5
Coding Project: C - Recursion
Coding Project: C - Recursion

    Weight: 75
    Project will start Mar 15, 2026 5:00 PM, must end by Mar 22, 2026 4:59 PM

You crushed it—keep that momentum going!
...
Nice going! Time to complete a short MCQ, and then on to the project!
